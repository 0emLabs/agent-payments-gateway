...
var modelPricing = [
  ...
  {
    model: "gemini-pro",
    promptCostPer1k: 125e-6,
    completionCostPer1k: 375e-6,
    currency: "USD"
  },
  {
    model: "gemini-ultra",
    promptCostPer1k: 25e-5,
    completionCostPer1k: 75e-5,
    currency: "USD"
  },
  {
    model: "llama-2-70b",
    promptCostPer1k: 75e-5,
    completionCostPer1k: 75e-5,
    currency: "USD"
  },
  {
    model: "mixtral-8x7b",
    promptCostPer1k: 4e-4,
    completionCostPer1k: 4e-4,
    currency: "USD"
  }
];
...
var UniversalTokenCounter = class {
  ...
  /**
   * Estimates the cost of a given number of tokens for a specific model.
   * @param tokens The number of tokens.
   * @param model The LLM model.
   * @param isCompletion Whether the tokens are for completion (vs. prompt).
  ...
  /**
   * Retrieves the pricing details for a specific model.
   * @param model The LLM model.
   * @returns The model pricing details or undefined if not found.
   */
